...
import com.yeslabapps.fictionfocus.adapter.VideoCommentsAdapter;
...
public class VideosCommentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_videos_comment);
        ...
        commentsAdapter = new VideoCommentsAdapter(this,commentsList);
    ...
    private void addvideoNotification( String postId, String publisher,String postpersonid) {
        ...
        map.put("text","commented on your video");
    ...
    private void putcomment() {
        HashMap<String,Object> map = new HashMap<>();
        DatabaseReference ref= FirebaseDatabase.getInstance("https://fictionary-d52fc-default-rtdb.europe-west1.firebasedatabase.app/").getReference()
                .child("VideoComments").child(postId);
        ...
        ref.child(commentid).setValue(map).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    addvideoNotification(postId,firebaseUser.getUid(),authorId);
                    addcomment.setText("");
                }else{
                    Toast.makeText(VideosCommentActivity.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private  void  getuserimage(){
        FirebaseDatabase.getInstance("https://fictionary-d52fc-default-rtdb.europe-west1.firebasedatabase.app/").getReference().child("Users").child(firebaseUser.getUid()).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
