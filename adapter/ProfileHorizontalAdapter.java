...
public class ProfileHorizontalAdapter extends RecyclerView.Adapter<ProfileHorizontalAdapter.ViewHolder> {

    private Context context;
    private ArrayList<FavoriteMovie> movieArrayList;
    private FirebaseUser firebaseUser;

    public ProfileHorizontalAdapter(Context context,ArrayList<FavoriteMovie>movieArrayList){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        final FavoriteMovie post = movieArrayList.get(position);
        ...
        holder.setPostimage(post.getFavoriteMoviePoster());

        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, MovieDetailsActivity.class);
                intent.putExtra(EXTRA_MESSAGE, post.getFavoriteJsonObject());  //parameter for activity
        ...
        holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                if ( post.getFavoriteUserId().endsWith(firebaseUser.getUid())){
                            ...
                            .setPositiveButton("Delete", R.drawable.ic_baseline_delete_24, new AbstractDialog.OnClickListener() {
                                ...
                                public void onClick(dev.shreyaspatil.MaterialDialog.interfaces.DialogInterface dialogInterface, int which) {
                                    FirebaseDatabase.getInstance("https://fictionary-d52fc-default-rtdb.europe-west1.firebasedatabase.app/")
                                            .getReference().child("ForProfile").child(post.getFavoritePostId()).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
