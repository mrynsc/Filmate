...
public class ProfileMovieAdapter extends RecyclerView.Adapter<ProfileMovieAdapter.ViewHolder> {
    ...
    public ProfileMovieAdapter(Context context,ArrayList<FirebaseMovie>movieArrayList){
                            ...
                            .setPositiveButton("Delete", R.drawable.ic_baseline_delete_24, new AbstractDialog.OnClickListener() {
                                ...
                                public void onClick(dev.shreyaspatil.MaterialDialog.interfaces.DialogInterface dialogInterface, int which) {
                                    FirebaseDatabase.getInstance("https://fictionary-d52fc-default-rtdb.europe-west1.firebasedatabase.app/")
                                            .getReference().child("Movies").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(post.getPostId())
