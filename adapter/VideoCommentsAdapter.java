...
public class VideoCommentsAdapter extends  RecyclerView.Adapter<VideoCommentsAdapter.ViewHolder>{
    ...
    public VideoCommentsAdapter(Context mcontext, List<Comments> mcomments) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.moreOptions.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                PopupMenu popupMenu = new PopupMenu(mcontext, holder.moreOptions);
                                    ...
                                    public void onClick(View view) {
                                        ...
                                        if (selectedId == -1) {
                                            ...
                                            refForReport = FirebaseDatabase.getInstance("https://fictionary-d52fc-default-rtdb.europe-west1.firebasedatabase.app/")
                                                    .getReference().child("VideoCommentReports");
            ...
            public boolean onLongClick(View view) {
                if (comments.getPublisher().equals(firebaseUser.getUid())){
                            ...
                            .setPositiveButton("Delete", R.drawable.ic_baseline_delete_24, new AbstractDialog.OnClickListener() {
                                ...
                                public void onClick(dev.shreyaspatil.MaterialDialog.interfaces.DialogInterface dialogInterface, int which) {
                                    FirebaseDatabase.getInstance("https://fictionary-d52fc-default-rtdb.europe-west1.firebasedatabase.app/")
                                            .getReference().child("VideoComments").child(comments.getPostId()).child(comments.getCommentid())
                    ...
                    ad.setButton(AlertDialog.BUTTON_POSITIVE, "Yes", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            FirebaseDatabase.getInstance("https://fictionary-d52fc-default-rtdb.europe-west1.firebasedatabase.app/").getReference().child("VideoComments").child(comments.getPostId()).child(comments.getCommentid())
                                    .removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()){
    ...
    /*private void addNotification( String postId, String publisher,String postpersonid,String text) {
        DatabaseReference ref = FirebaseDatabase.getInstance("https://quotebox-69d55-default-rtdb.europe-west1.firebasedatabase.app/")
        ...
        FirebaseDatabase.getInstance("https://quotebox-69d55-default-rtdb.europe-west1.firebasedatabase.app/").getReference().child("Notification").child(postpersonid).child(notificationId).setValue(map);
    ...
    public  class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            moreOptions=itemView.findViewById(R.id.moreItemComment);
        }
    }
}