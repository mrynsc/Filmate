...
import com.yeslabapps.fictionfocus.adapter.SeriesAdapter;
...
public class WatchedSeriesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FloatingActionButton addFavorites=view.findViewById(R.id.addSeries);
        ...
        usersSeries=view.findViewById(R.id.usersSeries);

        recyclerView = view.findViewById(R.id.movie_list);
        movieAdapter = new SeriesAdapter(getContext(), movieArrayList);
    ...
    private void userinfo() {
        FirebaseDatabase.getInstance("https://fictionary-d52fc-default-rtdb.europe-west1.firebasedatabase.app/")
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                usersSeries.setText(user.getUsername() + "'s series");
    ...
    private void readOldest() {
        movieArrayList=new ArrayList<>();
        FirebaseDatabase.getInstance("https://fictionary-d52fc-default-rtdb.europe-west1.firebasedatabase.app/").
                getReference().child("Series").child(profileReceiver).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
